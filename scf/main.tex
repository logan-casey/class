...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{participation_by_asset_percentile_raw.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{portfolio_shares_by_asset_percentile_raw.png}
\end{figure}
