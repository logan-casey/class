% main_solve.m
load('hw_solution_tightgrid_feb18_2iter_s01.mat')
opts = struct();
% initialize
...
eq = hw.solve_equilibrium_2iter(wgrid, zgrid, Pz, par, grid, opts);

save('hw_solution_tightgrid_feb18_2iter_nos.mat', 'eq', 'par', 'grid', 'wgrid', 'zgrid', 'Pz');
