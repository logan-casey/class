...
capture confirm variable loss_applied_2010
if _rc {
    di as err "Missing loss_applied_2010. Re-run clean_data.do."
    exit 111
}
...
* Match R timing: controls come from loss year (t-1) for outcome years 2002/2003.
...
gen pre_`yy'_sales_assets = L.sales_assets if in_`yy'
